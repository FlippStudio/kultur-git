            ...
            <div class="collapse navbar-collapse justify-content-end flex-column align-self-start" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-xl-none d-flex sign-in">
                        <a class="nav-link" href="<?php if(is_user_logged_in()): echo esc_url(admin_url()); else: echo esc_url(wp_login_url()); endif; ?>"><?php if(is_user_logged_in()): echo 'MÓJ PROFIL'; else: echo 'ZALOGUJ SIĘ'; endif; ?></a>
                    </li>
                    <?php if(is_user_logged_in()): ?>
