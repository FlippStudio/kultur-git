<?php /** Template Name: dodane przez niepełnosprawnych */ get_header(); ?>
    ...
    <div class="container">
      ...
      <?php
        ...
        foreach($posts as $post):
            if(get_user_meta( $post->post_author, 'type', true) == 'N' && $post->post_status != 'closed' && get_field('aktywne', $post->ID) == 1):
                $flag = true;
                break;
            endif;
        endforeach;
            ...
            if ($my_query->have_posts()) :
                ...
                while ($my_query->have_posts()) :
                    ...
                    $my_query->the_post(); ?>
                    <?php if(get_user_meta( $my_query->post->post_author, 'type', true) == 'N' && $my_query->post->post_status != 'closed'): ?>
