...
<section id="slider" class="d-sm-block d-none">
  <div class="container position-relative d-xl-block d-none">
    <img src="<?php bloginfo('template_directory'); ?>/img/main/slider/slider-back-xxl.png" alt="Tło slidera"
      class="slider-back">
    <img src="<?php bloginfo('template_directory'); ?>/img/main/slider/slider-back-contrast.png"
      alt="Tło slidera - kontrast" class="slider-back contrast">
      ...
      <div class="carousel-inner">
        <?php if ($my_query->have_posts()) :
                    ...
                    while ($my_query->have_posts()) :
                        ...
                        if ($ph) : ?>
        <div class="carousel-item <?php if ($my_query->current_post == 0) : echo 'active'; endif; ?>">
          <?php the_post_thumbnail('full', array('class' => 'd-block img.attachment-full')); ?>
  ...
  <div id="carousel-small" class="carousel slide d-xl-none d-block" data-interval="false" data-ride="carousel"
    data-pause="hover">
    <div class="carousel-inner">
      <?php if ($my_query->have_posts()) :
        ...
        <a href="<?php echo get_permalink(); ?>">
          <div class="news">
            <div class="photo-news flex-center">
              <div class="blackout flex-center" title="Kliknij, aby sprawdzić zawartość">
                <div class="click-it">
                  <img src="<?php bloginfo('template_directory'); ?>/img/main/news/tap.svg"
                    alt="Kliknij, aby sprawdzić zawartość">
                </div>
              </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="m-title">
          <small>
            Projekt realizowany w ramach "Inkubatora Dostępności" finansowanego ze środków Europejskiego Funduszu
            Społecznego
          </small>
        </h2>
      </div>
